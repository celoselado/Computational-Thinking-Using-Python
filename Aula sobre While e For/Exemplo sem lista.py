'''
Crie um programa em python que recebe como entrada quatro salário, o programa deve calcular a media salarial e exibir os salarios que estão abaixo da média.
'''
